...
page_fillable(
  ...
  layout_column_wrap(
    navset_card_tab(
      title = "Deviation from the emission target", 
      height = '1000px',
      nav_panel(
        title = "Absolute",
        fluidRow(
...
#set up highchart object
  hchart("pie", 
         ...
         hcaes(x = n_inventories_range, y = n, drilldown=n_inventories_range,
               color = c(
          "#d4444d", "#fed939", "#03c245")), 
         name="Cities per number of inventories")|>
  #add title
  #hc_title(text = "Number of inventories") |> 
...
drilldown_chart <- pie_chart |>
  ...
  #hc_title(text="Cities per number of inventories available") |> 
  hc_title(
...
reading_example <- bs_button(label = "Reading example", button_type = "default", button_size = "small") |> 
  bs_embed_popover(title = glue::glue("🟩 category means: {tab_inventories[3, 2] |> pull()} cities have 2 or more inventories"))
